  ...
  static List<Role> getAllRoles() {
    return [
      ...
      Role(
        ...
        specialAbility: 'Puede elegir una víctima cada noche',
      ),
      Role(
        id: 'aldeano',
        name: 'Aldeano',
      ...
      Role(
        ...
        category: RoleCategory.principal,
        specialAbility: 'Puede investigar a un jugador por noche',
      ),
      Role(
        id: 'doctor',
        name: 'Doctor',
        ...
        category: RoleCategory.principal,
        specialAbility: 'Puede proteger a un jugador por noche',
      ),
      Role(
        id: 'vengador',
        name: 'Vengador',
        ...
        category: RoleCategory.principal,
        specialAbility: 'Puede vengarse al morir',
      ),
      Role(
        id: 'bruja',
        name: 'Bruja',
        ...
        category: RoleCategory.principal,
        specialAbility: 'Tiene pociones de vida y muerte',
      ),
      ...
      Role(
        ...
        specialAbility: 'Se convierte en vidente si el vidente muere',
      ),
      Role(
        id: 'pacifista',
        name: 'Pacifista',
        ...
        category: RoleCategory.aldeanoFeliz,
        specialAbility: 'Revela un rol y evita la votación de ese día',
      ),
      Role(
        id: 'sacerdote',
        name: 'Sacerdote',
        ...
        category: RoleCategory.aldeanoFeliz,
        specialAbility: 'Puede matar al hombre lobo si logra encontrarlo, si no acierta muere él',
      ),
      Role(
        id: 'alcalde',
        name: 'Alcalde',
        ...
        category: RoleCategory.aldeanoFeliz,
        specialAbility: 'Su voto vale doble si su rol es público',
      ),
      Role(
        id: 'guardaespaldas',
        name: 'Guardaespaldas',
        ...
        category: RoleCategory.aldeanoFeliz,
        specialAbility: 'Puede proteger cada noche',
      ),
      Role(
        id: 'detective',
        name: 'Detective',
        ...
        category: RoleCategory.aldeanoFeliz,
        specialAbility: 'Puede verificar que 2 jugadores sean del mismo bando',
      ),
      Role(
        id: 'hombre_sabio',
        name: 'Hombre Sabio',
        ...
        category: RoleCategory.aldeanoFeliz,
        specialAbility: 'Inmune a ataques nocturnos',
      ),
      Role(
        id: 'vidente_aura',
        ...
        category: RoleCategory.aldeanoFeliz,
        specialAbility: 'Puede ver auras',
      ),
      Role(
        id: 'principe_apuesto',
      ...
      Role(
        id: 'dama_roja',
        name: 'Dama Roja',
        description: 'Si muere, todos los hombres lobo mueren también.',
        category: RoleCategory.aldeanoEnojado,
        specialAbility: 'Mata a todos los lobos al morir',
      ),
      Role(
        id: 'abuelita_gruñona',
        name: 'Abuelita Gruñona',
        description: 'Puede maldecir a un jugador cada noche.',
        category: RoleCategory.aldeanoEnojado,
        specialAbility: 'Puede maldecir',
      ),
      Role(
        id: 'borracho',
        name: 'Borracho',
